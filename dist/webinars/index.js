...
(() => {
  ...
  var require_moment_timezone = __commonJS({
    "node_modules/.pnpm/moment-timezone@0.5.43/node_modules/moment-timezone/moment-timezone.js"(exports, module) {
      init_live_reload();
  ...
  // node_modules/.pnpm/moment-timezone@0.5.43/node_modules/moment-timezone/data/packed/latest.json
  var require_latest = __commonJS({
    "node_modules/.pnpm/moment-timezone@0.5.43/node_modules/moment-timezone/data/packed/latest.json"(exports, module) {
      module.exports = {
        version: "2023c",
        zones: [
  ...
  var require_moment_timezone2 = __commonJS({
    "node_modules/.pnpm/moment-timezone@0.5.43/node_modules/moment-timezone/index.js"(exports, module) {
      init_live_reload();
  ...
  // src/webinars/shouldDisplayEvent.ts
  init_live_reload();
  var import_moment_timezone = __toESM(require_moment_timezone2(), 1);
  function shouldDisplayEvent(eventTime, eventTimeZone) {
    const currentTime = (0, import_moment_timezone.default)().tz(eventTimeZone);
    const diffHours = currentTime.diff(eventTime, "hours", true);
    return diffHours <= 1;
  }

  // src/webinars/index.ts
  function handleDateTimeElements(dateTimeElements) {
    dateTimeElements.forEach((dateTimeElement) => {
      ...
      const eventTime = import_moment_timezone2.default.tz(dateTimeData, "MMMM DD, YYYY hh:mm A", eventTimeZone);
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const dateTimeElements = document.querySelectorAll("[data-date-time-el]");
