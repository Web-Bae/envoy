...
const calculateTotals = () => {
  ...
  const workplacePlanEl = document.querySelector('input[name="Workplace-Plan"]:checked');
  const numEmployeesEl = document.querySelector('input[name="Employees"]');
  if (!workplacePlanEl || !numEmployeesEl) {
    console.error('Could not find billing period, workplace plan, or number of employees elements');
  ...
  const visitorsPlanEl = document.querySelector('input[name="Visitor-Plan"]:checked');
  ...
  const equipmentItemEls = document.querySelectorAll('.quote-calc_equipment-item');
...
const radioEls = document.querySelectorAll('input[type="radio"], input[type="number"]');
